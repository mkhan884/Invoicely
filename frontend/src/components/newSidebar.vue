<template lang="">
  <div>
    ...
    >
      <div
        class="overflow-y-auto py-5 px-3 h-full bg-gray-900 border-r border-gray-200"
      >
        <ul class="space-y-2">
          <li>
            <a
              href="#"
              class="flex items-center p-2 text-sm font-base text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg group"
            >
              <svg
                aria-hidden="true"
          ...
          <li>
            <button
              type="button"
              class="flex items-center p-2 w-full text-sm font-base text-gray-400 rounded-lg transition duration-75 group hover:bg-gray-800 hover:text-white"
